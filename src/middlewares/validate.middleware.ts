...
export const validate =
  ...
  (req: Request, _res: Response, next: NextFunction): void => {
    try {
      ...
      // Terapkan hasil parse (termasuk coercion & default zod) kembali ke req.body.
      // req.query/req.params di Express 5 adalah getter yang selalu re-parse,
      // jadi coercion untuk query/params dilakukan manual di controller.
